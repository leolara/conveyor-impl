// Package stomp is an implementation for github.com/leolara/conveyor of system stomp.
...
import (
	...
	upstream "github.com/micro/go-plugins/broker/stomp"

	"github.com/leolara/conveyor"
)

// NewBroker creates a conveyor broker based on stomp

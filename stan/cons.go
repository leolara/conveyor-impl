// Package stan is an implementation for github.com/leolara/conveyor of system stan.
...
import (
	...
	upstream "github.com/micro/go-plugins/broker/stan"

	"github.com/leolara/conveyor"
)

// NewBroker creates a conveyor broker based on stan
